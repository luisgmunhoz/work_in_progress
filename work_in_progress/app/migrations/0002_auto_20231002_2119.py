...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='secret',
            field=models.CharField(default=work_in_progress.app.models.get_new_uuid_hex, editable=False, max_length=100, unique=True),
        ),
        migrations.CreateModel(
            name='Processo',
            fields=[
                ...
                ('criado_por', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='processos', to='app.systemuser')),
            ],
        ),
        migrations.CreateModel(
            name='Company',
            fields=[
                ...
                ('atualizado_em', models.DateTimeField(auto_now=True)),
                ('ativo', models.BooleanField(default=True)),
                ('contato', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='companies', to='app.contato')),
                ('criado_por', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='companies', to='app.systemuser')),
            ],
        ),
    ]
